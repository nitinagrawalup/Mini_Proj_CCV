...
<body>
    ...
    <div class="container">
            <h1>Pay Loan</h1>
        <form action="deposit_calculate_validate.php" method="POST">
        
           
            <div class="form-group col-12">
				<label id="label">Amount</label>
				<input  class="form-control" type="number" step="any"  id="amount" required maxlength="5" name="amount" placeholder="Enter Amount ">
			</div>
            ...
            <div class="buton ">
                <button type="submit" class="btn btn-primary" id="btn" value="submit">Pay</button>
            </div>
