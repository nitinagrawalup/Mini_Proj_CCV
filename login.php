...
<body>
    ...
    <div class="container ">
        ...
        <form id="my_captcha_form" action="login_validate.php" method="POST" >
          
            <div class="form-group col-sm-6 col-lg-12">
				<label id="label">Account Number</label>
				<input  class="form-control" type="number" name="accno"  maxlength="6" id="pass" required  placeholder="Enter Account Number">
            </div>
			<div class="form-group col-sm-6 col-lg-12">
				<label id="label">Password</label>
				<input  class="form-control" type="password" name="pass" minlength="8" maxlength="16" id="pass" required  placeholder="Enter Password">
			</div>
