...
<body>
    ...
    <div class="container">
            <h1>Deposit Money</h1>
        <form action="deposit_validate.php" method="POST">
        
           
            <div class="form-group col-sm-6 col-lg-12">
				<label id="label">Amount</label>
				<input  class="form-control" type="number"  id="amount" required maxlength="5" name="amount" placeholder="Enter Amount ">
		    </div>
            <div class="form-group col-sm-6 col-lg-12">
				<label id="label">Time</label>
				<input  class="form-control" type="number"  id="amount" required maxlength="1" name="time" placeholder="Enter Amount ">
				<small>Intrest rate is 5%.</small>
			</div>
