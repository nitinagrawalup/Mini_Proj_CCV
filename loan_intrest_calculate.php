...
<head>
	...
	<link rel="stylesheet" type="text/css" href="loan_intrest_calculate.css">
...
<body>
    ...
    <div class="container">
        <h1>Enter details to calculate loan  amount.</h1>
        <form  action="loan_intrest_validate.php" method="POST" >
          
            <div class="form-group col-sm-6 col-lg-12">
				<label id="label">Present Value</label>
				
                <input  class="form-control" type="tel" name="present_val"  maxlength="8" id="pass" required  placeholder="Enter Amount ">
                
            </div>
			<div class="form-group col-sm-6 col-lg-12">
				<label id="label">Time period</label>
				<input  class="form-control" type="tel" name="time" maxlength="1"  id="time" required  placeholder="Enter time period">
                <small>Intrest rate is 14%.</small>
            </div>
            <div class="buton container">
                <button type="submit" class="btn btn-primary" id="btn" value="submit">Calculate</button>
            </div>
        </form>
	</div>
