...
<head>
	...
	<link rel="stylesheet" type="text/css" href="After_acc_create.css">
...
<body>
    ...
    <div class="info container">
            ...
            <ul >
                    <li>
                    <p>Your Account Number is <span style="color:RED"><u><?php echo $_SESSION['ACCOUNT_NO']; ?></u> </span></p>
                    </li>
                    <li>
                    <p>Your Username is <span style="color:blue"><u> <?php echo $_SESSION['USERNAME']; ?></u> </span></p>
                    </li>
                    <li>
                    <p>Your Password is <span style="color:green"><u><?php echo $_SESSION['PASS']; ?></u></span> </p>
                    </li>
            </ul>

    </div>
    <p class="small"><small><-----------Save this Information and don't share with anyone.-----------></small> </p>
