...
<head>
	...
	<link rel="stylesheet" type="text/css" href="successfully_tranfered.css">
...
<body>
    ...
    <div class="transfer container">
        ...
        <p>
            Loan transfered successfully.
        </p>
        <p>
        Your Account balance is Rs <?php echo $a ?>.
