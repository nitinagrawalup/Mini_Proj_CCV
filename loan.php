...
<body>
    ...
    <div class="container">
            <h1 style="text-align:center;"><u>Loan</u></h1>
        <form action="loan_validate.php" method="POST"> 
		   
			<div class="form-group col-sm-12 col-lg-12">
				<label id="label">Loan Type</label>
            ...
            <div class="form-group col-sm-12 col-lg-12">
            <label id="label">Enter Amount</label>
			<input  class="form-control" required type="number" maxlength="6"  id="loanamount" name="loan_amount" placeholder="Enter Amount for loan">
			<small>Loan amount should be less than 500000.</small>
			</div>
			
            <div class="form-group col-sm-12 col-lg-12">
            <label id="label">Time Period</label>
			<input  class="form-control" required type="number" maxlength="6"  id="loanamount" name="time" placeholder="Enter Time for which loan is taken">
			<small>Intrest rate is 14%.</small>
			</div>
            ...
            <div class="buton container">
                <button type="submit" class="btn btn-primary" id="btn" value="submit">Submit</button>
            </div>
        </form>
	</div>
